...
public class ClickOnCommercialUmbrella implements Task {
...
//    }
    @Override
    @Step("{0} Click On Commercial Umbrella")
    public <T extends Actor> void performAs(T actor) {
        InsuranceSolutions.COMMERCIAL_LINES_UMBRELLA.resolveFor(actor).waitUntilVisible();
        actor.attemptsTo(

                Click.on(InsuranceSolutions.COMMERCIAL_LINES_UMBRELLA)
        );
    }
