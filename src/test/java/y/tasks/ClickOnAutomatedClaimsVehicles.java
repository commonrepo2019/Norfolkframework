...
public class ClickOnAutomatedClaimsVehicles implements Task {
...
//    }
    @Override
    @Step("{0} Click On Automated Claims Vehicles")
    public <T extends Actor> void performAs(T actor) {
        ClaimsServices.AUTOMATED_CLAIMS_VEHICLES.resolveFor(actor).waitUntilVisible();
        actor.attemptsTo(

                Click.on(ClaimsServices.AUTOMATED_CLAIMS_VEHICLES)
        );
    }
