...
public class ClickOnPersonalLines implements Task {
...
//    }
    @Override
    @Step("{0} Click On Personal Lines")
    public <T extends Actor> void performAs(T actor) {
        InsuranceSolutions.PERSONAL_LINES.resolveFor(actor).waitUntilVisible();
        actor.attemptsTo(

                Click.on(InsuranceSolutions.PERSONAL_LINES)
        );
    }
