...
public class ClickOnContactUs implements Task {
...
//    }
    @Override
    @Step("{0} Click on  Contact Us")
    public <T extends Actor> void performAs(T actor) {
        AboutND.CONTACT_US_SUB_MENU.resolveFor(actor).waitUntilVisible();
        actor.attemptsTo(

                Click.on(AboutND.CONTACT_US_SUB_MENU)
        );
    }
