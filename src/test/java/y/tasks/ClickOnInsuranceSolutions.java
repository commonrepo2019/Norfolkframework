...
public class ClickOnInsuranceSolutions implements Task {
...
//    }
    @Override
    @Step("{0} Click On Insurance Solutions")
    public <T extends Actor> void performAs(T actor) {
        InsuranceSolutions.INSURANCE_SOLUTIONS.resolveFor(actor).waitUntilVisible();
        actor.attemptsTo(

                Click.on(InsuranceSolutions.INSURANCE_SOLUTIONS)
        );
    }
