...
public class ClickOnPersonalLinesAuto implements Task {
...
//    }
    @Override
    @Step("{0} Click On Personal Lines Auto")
    public <T extends Actor> void performAs(T actor) {
        InsuranceSolutions.PERSONAL_LINES_AUTO.resolveFor(actor).waitUntilVisible();
        actor.attemptsTo(

                Click.on(InsuranceSolutions.PERSONAL_LINES_AUTO)
        );
    }
