...
public class ClickOnClients implements Task {
...
//    }
    @Override
    @Step("{0} Click on  Clients")
    public <T extends Actor> void performAs(T actor) {
        AboutND.OUR_CLIENTS_SUB_MENU.resolveFor(actor).waitUntilVisible();
        actor.attemptsTo(

                Click.on(AboutND.OUR_CLIENTS_SUB_MENU)
        );
    }
