...
public class ClickOnWhoWeAre implements Task {
...
//    }
    @Override
    @Step("{0} Click on  Who we are")
    public <T extends Actor> void performAs(T actor) {
        AboutND.WHO_WE_ARE_SUB_MENU.resolveFor(actor).waitUntilVisible();
        actor.attemptsTo(

                Click.on(AboutND.WHO_WE_ARE_SUB_MENU)
        );
    }
