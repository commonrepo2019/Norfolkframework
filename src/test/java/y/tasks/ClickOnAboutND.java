...
public class ClickOnAboutND implements Task {
...
//    }
@Override
    @Step("{0} Click on  ABOUT_ND_MAIN_MENU")
    public <T extends Actor> void performAs(T actor) {
    AboutND.ABOUT_ND_MAIN_MENU.resolveFor(actor).waitUntilVisible();
        actor.attemptsTo(

                Click.on(AboutND.ABOUT_ND_MAIN_MENU)
        );
    }
