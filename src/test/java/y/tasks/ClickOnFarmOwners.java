...
public class ClickOnFarmOwners implements Task {
...
//    }
    @Override
    @Step("{0} Click On Farm Owners")
    public <T extends Actor> void performAs(T actor) {
        InsuranceSolutions.FARM_OWNERS.resolveFor(actor).waitUntilVisible();
        actor.attemptsTo(

                Click.on(InsuranceSolutions.FARM_OWNERS)
        );
    }
