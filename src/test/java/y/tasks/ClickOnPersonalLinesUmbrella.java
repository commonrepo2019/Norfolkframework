...
public class ClickOnPersonalLinesUmbrella implements Task {
...
//    }
    @Override
    @Step("{0} Click On Personal Lines Umbrella")
    public <T extends Actor> void performAs(T actor) {
        InsuranceSolutions.PERSONAL_LINES_UMBRELLA.resolveFor(actor).waitUntilVisible();
        actor.attemptsTo(

                Click.on(InsuranceSolutions.PERSONAL_LINES_UMBRELLA)
        );
    }
