...
public class ClickOnMABodyShops implements Task {
...
//    }
    @Override
    @Step("{0} Click On MA Body Shops")
    public <T extends Actor> void performAs(T actor) {
        ClaimsServices.MA_BODY_SHOPS.resolveFor(actor).waitUntilVisible();
        actor.attemptsTo(

                Click.on(ClaimsServices.MA_BODY_SHOPS)
        );
    }
